    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-3xl">
          ...
          {/* Error Details Card */}
          <Card className="bg-background/60 backdrop-blur-sm border border-default-100/50 mb-6">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    {error.stack && (
                      <div>
                        ...
                        <Code
                          className="text-xs max-h-32 overflow-y-auto block whitespace-pre-wrap"
                          color="default"
                        >
                          {error.stack}
                        </Code>
