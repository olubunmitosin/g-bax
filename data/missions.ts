...
import { RESOURCE_TYPES, MISSION_TYPES } from '@/utils/constants';
...
export const MISSION_CATEGORIES = {
  ...
  INTERMEDIATE: {
    ...
    missions: ['mining_002', 'mining_003', 'exploration_002', 'exploration_003', 'crafting_002'],
  },
  ADVANCED: {
...
export const MISSION_REQUIREMENTS = {
  ...
  advanced_001: { level: 8, completedMissions: ['exploration_002', 'exploration_003'] },
  advanced_002: { level: 7, completedMissions: ['mining_003'] },
  advanced_003: { level: 10, completedMissions: ['advanced_001', 'advanced_002'] },
};
...
export function getMissionsByCategory(category: keyof typeof MISSION_CATEGORIES): Mission[] {
